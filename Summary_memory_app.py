...
def summarize_messages(chain_input):
    ...
    summarization_prompt = ChatPromptTemplate.from_messages(
        [
            ...
            (
                "user",
                "Yukarıdaki sohbet mesajlarını tek bir özet mesajına indir. Mümkün olduğunca çok spesifik detayı dahil et.",
            ),
        ]
    )
    summarization_chain = summarization_prompt | chat | parser
